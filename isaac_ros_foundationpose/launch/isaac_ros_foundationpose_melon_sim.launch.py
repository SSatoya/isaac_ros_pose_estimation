...
VISUALIZATION_DOWNSCALING_FACTOR = 10  # 可視化用画像のダウンサンプリング（縮小）倍率
...
FOUNDATIONPOSE_MODELS_PATH = os.path.join(ISAAC_ROS_MODELS_PATH, 'foundationpose')
REFINE_ENGINE_PATH = os.path.join(FOUNDATIONPOSE_MODELS_PATH, 'refine_trt_engine.plan')
SCORE_ENGINE_PATH = os.path.join(FOUNDATIONPOSE_MODELS_PATH, 'score_trt_engine.plan')
...
def generate_launch_description():
    ...
    drop_node = ComposableNode(
        ...
        remappings=[
            ...
            ('image_1_drop', '/rgb/image_rect_color'),
            ('camera_info_1_drop', '/rgb/camera_info'),
            ('depth_1_drop', '/depth/image_rect_raw'),
        ]
    )
    ...
    #         ('image_raw', '/camera/aligned_depth_to_color/image_raw_drop'),
    #         # ('image', 'depth_image')
    #         ('image', '/depth_image')
    #     ]
    # )
    ...
    foundationpose_node = ComposableNode(
        ...
        remappings=[
            ...
            ('pose_estimation/depth_image', '/depth/image_rect_raw'),
            # ('pose_estimation/depth_image', '/depth_image'),
            ('pose_estimation/image', '/rgb/image_rect_color'),
            ('pose_estimation/camera_info', '/rgb/camera_info'),
            ('pose_estimation/segmentation', 'segmentation')
